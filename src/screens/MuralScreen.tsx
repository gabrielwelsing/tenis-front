      ...
      <div style={sc.card}>
        ...
        <div style={sc.infoBox}>
          ...
          <div style={sc.infoCell}>
            <span style={sc.infoCellIcon}>📅</span>
          ...
          {/* Horário + local */}
          <div style={{ ...sc.infoCell, alignItems: 'flex-start', gap: 5, padding: '10px 10px' }}>
...
const sc: Record<string, React.CSSProperties> = {
  ...
  // Info box — fundo mais claro
  infoBox: { display: 'flex', alignItems: 'stretch', background: '#fff8f4', borderRadius: 14, overflow: 'hidden', border: '1px solid rgba(198,107,77,0.08)' },
  infoCell: { flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2, padding: '10px 8px' },
  divider: { width: 1, background: 'rgba(198,107,77,0.08)', flexShrink: 0 },
  infoCellIcon: { fontSize: 14, lineHeight: 1, marginBottom: 2 },
  hojeLabel: { fontSize: 9, fontWeight: 950, color: '#c66b4d', letterSpacing: 0.8, textTransform: 'uppercase' as const },
  diaNum: { fontSize: 24, fontWeight: 950, color: '#2d2521', lineHeight: 1 },
  mesLabel: { fontSize: 10, fontWeight: 850, color: '#a29186', letterSpacing: 0.5 },
  dataFimLabel: { fontSize: 9, color: '#b5a69d', fontWeight: 700, textAlign: 'center' as const },
  horarioRow: { display: 'flex', alignItems: 'center', gap: 5 },
  horarioText: { fontSize: 12, fontWeight: 900, color: '#2d2521' },
  localText: { fontSize: 11, fontWeight: 700, color: '#8f7769', lineHeight: 1.3 },
  interessNum: { fontSize: 20, fontWeight: 950, color: '#c66b4d', lineHeight: 1 },
  interessLabel: { fontSize: 10, fontWeight: 700, color: '#a29186', textAlign: 'center' as const },

  furoBadge: { alignSelf: 'flex-start', fontSize: 11, fontWeight: 850, padding: '5px 10px', borderRadius: 999, background: '#fff0ec', color: '#c95441' },

  // Botão WA menor
  btnRow: { display: 'grid', gridTemplateColumns: '1fr 40px', gap: 8 },
  waBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, padding: '10px 12px', borderRadius: 12, background: 'linear-gradient(135deg, #c66b4d, #934836)', color: '#fff', fontSize: 12, fontWeight: 900, textDecoration: 'none', boxShadow: '0 6px 14px rgba(147,72,54,0.18)' },
  calBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: 12, background: '#f5ebe4', color: '#8f4a39', fontSize: 17, textDecoration: 'none' },
